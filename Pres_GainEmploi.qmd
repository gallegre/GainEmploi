...
## Niveau de vie et taux de pauvreté avec un emploi au smic à mi-temps
...
## Niveau de vie et taux de pauvreté avec un emploi au smic à temps complet
...
-   Simulation d'une réforme à coût constants : ne pas déclarer les revenus inférieurs à 450 par trimestre quelle que soit leur nature et réduite le taux e cumul avec les revenus d'activité de 61% à 58,5%
    ...
    *des gagants dans le 1er décile, des perdants (pour de faibles montants) dans le 4ème décile*
...
A la redistribution et l’incitation, s’ajoute un autre objectif : **rémunérer le « mérite »** : **deux philosophies** s'opposent.
...
-   le **RSA et une prime d’activité entièrement familialisée** (sans bonus individuels) ont pour seul objectifs de lutter contre la pauvreté et les inégalités de niveau de vie
    ...
    *Possibilité d'inclue les allocations chômage dans les "revenus d'activité"*
