...
basegr$casconj <- factor(basegr$casconj,levels=c("Sans conjoint","Conjoint sans revenu", "Conjoint chômeur","Conjoint au smic", "Conjoint à 1,5 smic"))
...
graph4 <- ggplot() +
  ...
  labs(title = "Les taux de gains du passage à plein-temps sont plus hétèrogènes en présence d'un conjoint")+
  theme(
    axis.title.x = element_blank(),
    axis.title.y = element_blank(),
    legend.title = element_blank(),
    ...
    axis.line = element_line(color = "black", linewidth = 0.2, linetype = "solid"),
    axis.text.x = element_text(size = rel(1.2), angle = 40, hjust = 1, vjust = 1),
    plot.title = element_text(size = rel(1.2), color="#5E4FA2")
  )
