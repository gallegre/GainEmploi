...
format:
  ...
  wp-pdf:
    toc: false
    output-file: "OFCEWP2025-24p.pdf"
editor: visual
...
```{r}
#| label: fig-garde
#| fig-cap: Revenu disponible d'une famille avec un enfant gardé par sa mère et/ou une assitante maternelle
#| fig-asp: 0.8
...
graphMS <- Bareme_long %>%
  ...
  ofce_caption(
  source = "DREES",
  note = "base 100 = 1990 ; Smic horaire et minima sociaux en euros constants"
  )
