...
graph <- ggplot(basegr %>% filter(name !='RDISP'), aes(fill = name,
  ...
  geom_text(
    aes(x = 0.5, y = seuilpm + 125, label = "Seuil de pauvreté (à 60%)"),
    size = 3, 
...
graph3 <- ggplot(basegr1, aes(fill = name, y = value, x = typrev)) + 
  ...
  geom_text(
    aes(x = 0.5, y = seuilpm + 250, label = "Seuil de pauvreté (à 60%)"),
    size = 3, 
    hjust = 0, # Left-justified
    colour = "grey40"
  ) +
  ...
  geom_text(
    aes(x = 0.5, y = (4 / 6) * seuilpm + 270, label = "Seuil de grande \npauvreté (40%)"),
    size = 3, 
    hjust = 0, # Left-justified
    colour = "grey40"
  ) +
...
graph3b <- ggplot(basegr1, aes(fill = name, y = value, x = typrev)) + 
  ...
  geom_text(
    aes(x = 0.5, y = (4 / 6) * seuilpm + 390, label = "Seuil de grande \npauvreté (40%)"),
    size = 3, 
    hjust = 0, # Left-justified
    colour = "grey40"
  ) +
...
graphC1_S <- ggplot(basegr %>% filter(name !='RDISP_NET_CG'), aes(fill = name,
  ...
  geom_text(
    aes(x = 0.5, y = seuilpm + 150, label = "Seuil de pauvreté (à 60%)"),
    size = 3, 
    hjust = 0, # Left-justified
    colour = "grey20"
  ) +
