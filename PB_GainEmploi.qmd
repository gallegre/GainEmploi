...
graph3b <- ggplot()+
  geom_bar(data = basegr1, aes(fill = name, y = value, x = typrev, text = paste("Revenu disponible :",round(value,0), "euros")), size = 3 +
...
graphG2 <- ggplot() +
  ...
  labs(title = " -Les taux marginaux d'imposition sont devenus plus élevés sur les revenus médians (gains plus faibles)",
