...
# 4. Peut-on dépasser les dilemmes du système actuel et prendre au sérieux l'objectif de lutte contre la pauvreté?
...
Le dilemme entre redistribution et incitation est un trilemme (redistribution/incitation/coût budgétaire). Une solution permettant de réduire le coût serait de réduire bien plus fortement le taux de cumul entre prestation d'assistance et revenus du travail, de sorte que les bénéfices de la hausse soient ciblés sur les plus pauvres. Nous avons simulé des scénarios dans ce sens (taux de cumul de 35%) mais il fait des perdants très bas dans l'échelle de revenus.
...
## 4.2 Que faire du temps partiel ? Un marche-pied ou le rendre hors-norme ?
...
## 4.3 Comment aider autour du temps-plein ? Par le Smic ou la prime d'activité ? Un autre moyen ?
